...
public:
	...
	GUI(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Podstawy Grafiki Komputerowej - Lab 8 - Adrian Góral"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(1116, 577), long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL);
